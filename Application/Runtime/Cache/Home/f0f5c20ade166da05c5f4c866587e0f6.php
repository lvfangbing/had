...
<div class="had-container" style="height: 600px;">
    ...
    <div id="companyNews" class="section-news" style="height: auto;">
        <p>
        </p><h3 style="text-align:center">开呗2.0隆重上线</h3>
        <h4 style="text-align:center; color:#666">发布日期：2015-02-06</h4>
        <hr style="border: 1px solid #808080;">
        <br>
        <p class="p-low">
            2014年2月6日海德在线研发的的产品开呗APP V2.0正式上线，，感谢各位从海德在线成立以一直来支持和关心开呗的朋友们，欢迎各位去下载使用，提出宝贵意见。
        </p>
    </div>
