...
<div class="had-container" style="height: 600px;">
    ...
    <div id="companyNews" class="section-news" style="height: auto;">
        <p>
        </p><h3 style="text-align:center">91车助手隆重上线、启动盛大公测</h3>
        <h4 style="text-align:center; color:#666">发布日期：2014-12-18</h4>
        <hr style="border: 1px solid #808080;">
        <br>
        <p class="p-low">
            2014年12月18日海德在线研发的的产品91车助手APP V1.0正式上线，盛大公测，感谢各位从海德在线成立以一直来支持和关心91车助手的朋友们，欢迎各位去下载试用，提出宝贵意见。
           </p>
        <center><a href="http://www.91czs.com"><img src="/Public/Images/official-app.jpg" width="600" height="300"></a></center>
    </div>
