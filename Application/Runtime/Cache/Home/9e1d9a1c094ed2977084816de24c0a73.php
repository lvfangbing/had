...
<div class="had-container" style="height: 850px;">
    ...
    <div id="companyNews" class="section-news" >
        <h3 style="text-align:center">1分钱洗车活动</h3>
        <h4 style="text-align:center; color:#666">发布日期：2015-01-17</h4>

        <br>
        <a  href="http://www.ikaibei.com" style="margin-left: 40px;color: #ff9326;"><img src="/Public/Images/checkcarjpg"></a>
            <p><strong> &nbsp; &nbsp;&nbsp; &nbsp;活动目的：让爱车更加干净，让城市更加美丽。</strong>
