...
<div class="had-container" style="height: 850px;">
    ...
    <div id="companyNews" class="section-news" >
        <h3 style="text-align:center">开呗V2.1版本发布在即</h3>
        <h4 style="text-align:center; color:#666">发布日期：2015-02-04</h4>
        <hr style="border: 1px solid #808080;">
        <br>
        <p class="p-low">2015年3月6日（正月十六），我公司推出开呗V2.1版本，在原有V2.0版本的基础上进行了BUG修复和换肤，新版本在原有版本的基础上进行了优化，让用户体验更加极致和美观。</p>

        <p><strong>&nbsp; &nbsp;&nbsp; &nbsp;<a style="color: #ff9326;" href="http://www.91czs.com">欢迎下载 | 扫描下面的二维码！</a> </strong></p>
        <br>
