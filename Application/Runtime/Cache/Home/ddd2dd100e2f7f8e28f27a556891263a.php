...
<div class="had-container" style="height: 850px;">
    ...
    <div id="companyNews" class="section-news">
        <h3 style="text-align:center">1元钱检测活动</h3>
        <h4 style="text-align:center; color:#666">发布日期：2015-01-17日</h4>
        <br>

        <a  href="http://www.91czs.com" style="margin-left: 40px;color: #ff9326;"><img src="/Public/Images/washcar.jpg"></a>
        <p ><strong> &nbsp; &nbsp;&nbsp; &nbsp;活动目的：让我们无忧的开车回家过年</strong>
        <p><strong> &nbsp; &nbsp;&nbsp; &nbsp;活动对象：深圳所有车主的爱车</strong>
        <p><strong> &nbsp; &nbsp;&nbsp; &nbsp;活动时间：2015年1月15日-2015年2月14日</strong>
        <p><strong> &nbsp; &nbsp;&nbsp; &nbsp;活动要求：更多活动优惠尽在“<a style="color: #ff9326;" href="http://www.91czs.com" >开呗</a>”应用</strong>
        <p><strong>&nbsp; &nbsp;&nbsp; &nbsp;<a style="color: #ff9326;" href="http://www.91czs.com">详情进入官方网站 | 扫描下面的二维码</a> </strong></p>
        <br>
        <a  href="http://www.91czs.com" style="margin-left: 40px;color: #ff9326;"><img src="/Public/Images/erweima.png"></a>
