...
//	public $lastSuffix = true; // 最后一页是否显示总页数
    ...
    public function show() {
        ...
        if($this->totalPages > $this->rollPage && ($this->nowPage + $now_cool_page) < $this->totalPages){
            $the_end = '<li><a  href="' . $this->url($this->totalPages) . '">' . $this->config['last'] . '</a><l/i>';
        }
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return " <li><a class='well'>总 {$this->totalRows}条记录</a></li> {$page_str} <li><a>总{$this->totalPages}页</a></li>";
